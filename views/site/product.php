            ...
            <div class="about-product left">
                ...
                <div class="horizontal-share">
                    <a rel="nofollow"  title="ВКонтакте" class="b-share__handle b-share__link b-share-btn__vkontakte"
                        href="http://vk.com/share.php?url=http://<?= Yii::$app->getRequest()->serverName?>/product/<?= $product->id?>&title=<?= urlencode($product->name)?>&description=<?= urlencode($product->description)?>&image=<?= $product->images[0]->imageFileName;?>"
                    ...
                    <a rel="nofollow" target="_blank" title="Facebook" class="b-share__handle b-share__link b-share-btn__facebook"
                        href="https://www.facebook.com/sharer/sharer.php?sdk=joey&u=http://<?= Yii::$app->getRequest()->serverName?>/product/<?= $product->id?>&title=<?= urlencode($product->name)?>&description=<?= urlencode(strip_tags($product->description))?>&image=<?= $product->images[0]->imageFileName;?>"
